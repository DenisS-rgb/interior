        ...
        <div className="flex flex-row gap-4 text-base font-nunito items-center">
          ...
          <div className="flex flex-row gap-2 items-center">
            <Link href="tel:+404012013012310" className="flex flex-row gap-2 items-center hover:text-gray-300 cursor-pointer transition-colors">
              ...
              <p className="hidden xl:block">+40 4012 013012310</p>
            </Link>
          </div>
        ...
        <div className="lg:hidden absolute top-full left-0 w-full bg-black/95 backdrop-blur-sm z-50">
          <div className="flex flex-col p-6 space-y-6">
            ...
            <ul className="flex flex-col space-y-4 font-nunito text-lg">
              <li className="hover:text-gray-300 cursor-pointer transition-colors border-b border-gray-700 pb-2"><Link href="#about" onClick={() => setIsMobileMenuOpen(false)}>About</Link></li>
              <li className="hover:text-gray-300 cursor-pointer transition-colors border-b border-gray-700 pb-2"><Link href="#team" onClick={() => setIsMobileMenuOpen(false)}>Team</Link></li>
              <li className="hover:text-gray-300 cursor-pointer transition-colors border-b border-gray-700 pb-2"><Link href="#services" onClick={() => setIsMobileMenuOpen(false)}>Services</Link></li>
              <li className="hover:text-gray-300 cursor-pointer transition-colors border-b border-gray-700 pb-2"><Link href="#portfolio" onClick={() => setIsMobileMenuOpen(false)}>Portfolio</Link></li>
            </ul>
            ...
            <Link href="tel:+404012013012310" className="flex flex-row gap-2 items-center hover:text-gray-300 cursor-pointer transition-colors">
              <Image src="/svg/phone.svg" alt="Phone" width={25} height={25} />
              <p className="text-sm sm:text-base">+40 4012 013012310</p>
            </Link>
            </div>
